...
namespace ConsoleOutputScanner
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Kullanım: ConsoleOutputScanner.exe [PIN]");
                ...
                var scanData = new
                {
                    ...
                    scannerId = $"COS-{DateTime.Now:yyyyMMdd}-{Guid.NewGuid().ToString("N")[..8].ToUpper()}"
                };
