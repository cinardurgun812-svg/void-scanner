...
namespace WorkingVoidScanner
{
    class Program
    {
        ...
        {
            Console.WriteLine("╔══════════════════════════════════════╗");
            Console.WriteLine("║        VOID SCANNER WORKING           ║");
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Kullanım: WorkingVoidScanner.exe [PIN]");
                ...
                var scanData = new
                {
                    ...
                    encryptedData = "working_scanner_data",
                    scannerId = $"WVS-{DateTime.Now:yyyyMMdd}-{Guid.NewGuid().ToString("N")[..8].ToUpper()}"
                };
