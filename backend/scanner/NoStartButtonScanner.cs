...
namespace NoStartButtonScanner
{
    class Program
    {
        ...
        {
            Console.WriteLine("╔══════════════════════════════════════╗");
            Console.WriteLine("║        NO START BUTTON SCANNER       ║");
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Kullanım: NoStartButtonScanner.exe [PIN]");
                ...
                var scanData = new
                {
                    ...
                    encryptedData = "no_start_button_scanner_data",
                    scannerId = $"NSB-{DateTime.Now:yyyyMMdd}-{Guid.NewGuid().ToString("N")[..8].ToUpper()}"
                };
