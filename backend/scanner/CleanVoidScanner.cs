...
namespace CleanVoidScanner
{
    class Program
    {
        ...
        {
            Console.WriteLine("╔══════════════════════════════════════╗");
            Console.WriteLine("║        CLEAN VOID SCANNER            ║");
            ...
            try
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Kullanım: CleanVoidScanner.exe [PIN]");
                ...
                var scanData = new
                {
                    ...
                    scannerId = $"CVS-{DateTime.Now:yyyyMMdd}-{Guid.NewGuid().ToString("N")[..8].ToUpper()}"
                };
